...
public class Contexte {
    ...
    private List<Utilisateur> utilisateurList=null;         // La liste des utilisateurs
    ...
    public Contexte() {
        ...
        Utilisateur dupontin=new Utilisateur(getUniqueUid(Utilisateur.class),"popol.dupontin@gmail.com", "Dupontin Popol",
                "15 rue de metz", "","toulouse","31000","0606060608");
        utilisateurList.add(dupontin);
        ...
        Utilisateur durantin=new Utilisateur(getUniqueUid(Utilisateur.class), "popol.durantin@gmail.com", "Durantin Popol", "10, avenue alsace lorraine","","Toulouse","31000","0606060608");
        utilisateurList.add(durantin);
        ...
        Utilisateur pontin=new Utilisateur(getUniqueUid(Utilisateur.class),"raymond.pontin@gmail.com", "Pontin Raymond", "5, Allée A Machado","","Toulouse","","0606060608");
        utilisateurList.add(pontin);
    ...
    public void ajouterService(Service service)
    {
        ...
        service.setUid(uid);
        Utilisateur u = findUtilisateurByUid(service.getFournisseurUid());
        u.getServicesList().add(service.getUid());
...
//        System.out.println("Réservation:"+ reservation.getUid()+" "+reservation.getServiceUid()+" à "+reservation.getDateTime()+" de #"+reservation.getQuantite()+" ");
    ...
    // Recherche d'un utilisateur par son UID dans la liste des utilisateurs en mémoire
    public Utilisateur findUtilisateurByUid(String uid)
    {
